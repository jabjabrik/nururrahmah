                ...
                <div class="col-12">
                    <div class="row justify-content-center">
                        <div class="col-lg-6 text-center">
                            <h1 class="mb-4 heading text-white" data-aos="fade-up" data-aos-delay="100">Visi & Misi <br> <span style="color: #d4d400;">MI Nurur Rahmah</span></h1>
        ...
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    ...
                    <p data-aos="fade-up" style="color: #d8d8d8; font-size: .9em;" data-aos-delay="100"><?= $informasi->visi ?></p>
                    <div class="section-title mb-3" data-aos="fade-up" data-aos-delay="0">
